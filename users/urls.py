...
urlpatterns = [
    ...
    path("edit_profile/", views.edit_profile, name="user-edit-profile"),
    path("interests/", views.user_interests, name="user-interests"),
    path("manage_interests/", views.manage_interests, name="manage-interests"),
